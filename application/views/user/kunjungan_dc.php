...
<div class="container">
	<div class="card" style="margin-top: 40px;margin-bottom: 40px">
	  <div class="card-header">
	    <center>
			<h1>FORMULIR KUNJUNGAN DATA CENTER</h1>
		</center>
	  </div>
	  <div class="card-body">
	  	...
	  	<?php if($this->session->flashdata('dc')) : ?>
			  ...
			  Selamat, <b><?= $this->session->flashdata('dc'); ?></b> telah berhasil dikirim, silahkan tunggu 2x24 jam untuk pemrosesan formulir. Jika formulir sudah kami periksa, kami akan mengirim pesan pemberitahuan via <b>WhatsApp</b> ...
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
			    <span aria-hidden="true">&times;</span>
			  </button>
			</div>
