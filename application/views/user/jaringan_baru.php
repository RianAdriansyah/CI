...
<div class="container">
	<div class="card" style="margin-top: 40px;margin-bottom: 40px">
		<div class="card-header">
			<center>
				<h1>FORMULIR PERMOHONAN PEMASANGAN JARINGAN BARU</h1>
			</center>
		</div>
		<div class="card-body">

			<?php if ($this->session->flashdata('jb')) : ?>
				<div class="alert alert-success alert-dismissible fade show" role="alert">
					Selamat, <b><?= $this->session->flashdata('jb'); ?></b> telah berhasil dikirim, silahkan tunggu 2x24 jam untuk pemrosesan formulir. Jika formulir sudah kami periksa, kami akan mengirim pesan pemberitahuan via <b>WhatsApp</b> ...
