...
<html><head>
    ...
    <hr>
    <?php if ($rd) : ?>
        <center><h5>LAPORAN FORMULIR RESET PASSWORD EMAIL DOSEN <?= $m3 .' '. $y3 ?></h5></center>
        <br><br>
    ...
    <?php else : ?>
        <br><br><br><br><br><br><center><h4>TIDAK ADA FORMULIR RESET PASSWORD EMAIL DOSEN <br> PADA <?= $m3 .' '. $y3 ?></h4></center>
    <?php endif ; ?>
