...
<html><head>
    ...
    <hr>
    <?php if ($rl) : ?>
        <center><h5>LAPORAN FORMULIR RESET PASSWORD EMAIL LEMBAGA <?= $m3 .' '. $y3 ?></h5></center>
        <br><br>
        <table style="width: 100%;font-size: 11px;border-collapse: collapse;">
            ...
            <tr>
                ...
                <td style="border: 1px solid black;" width="47.5%">
                    <table width="100%">
                        <tr>
                            <td class="tbody" width="5%">Nama Lembaga</td>
                            <td class="tbody" width="95%">: <?= $row->nama_lembaga ?></td>
                        </tr>
                        <tr>
                            <td class="tbody" width="5%">Penanggung Jawab</td>
                            <td class="tbody" width="95%">: <?= $row->nama_penanggung ?></td>
                        </tr>
                        <tr>
    ...
    <?php else : ?>
        <br><br><br><br><br><br><center><h4>TIDAK ADA FORMULIR RESET PASSWORD EMAIL LEMBAGA <br> PADA <?= $m3 .' '. $y3 ?></h4></center>
    <?php endif ; ?>
