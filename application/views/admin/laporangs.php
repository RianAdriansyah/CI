...
<html><head>
    ...
    <hr>
    <?php if ($gs) : ?>
        <center><h5>LAPORAN FORMULIR PERGANTIAN SERVER DATA CENTER <?= $m3 .' '. $y3 ?></h5></center>
        <br><br>
                    ...
                    <table style=" border-collapse: collapse;" width="100%">
                        <tr>
                            <td class="tbody" width="5%">
                             ...
                             <td class="tbody" style="border: 0.5px solid black;" class="text" width="30%" rowspan="8">
                                Permohonan :<br> <?= $row->permohonan ?>           
                             </td>
                             <td class="tbody" style="border: 0.5px solid black;" class="text" width="30%" rowspan="8">
    ...
    <?php else : ?>
        <br><br><br><br><br><br><center><h4>TIDAK ADA FORMULIR PERGANTIAN SERVER DATA CENTER <br> PADA <?= $m3 .' '. $y3 ?></h4></center>
    <?php endif ; ?>
</body></html>     