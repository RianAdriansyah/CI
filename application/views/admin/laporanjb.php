...
<html><head>
    ...
    <hr>
    <?php if ($jb) : ?>
        <center><h5>LAPORAN FORMULIR PERMOHONAN PEMASANGAN JARINGAN BARU <?= $m3 .' '. $y3 ?></h5></center>
        <br><br>
    ...
    <?php else : ?>
        <br><br><br><br><br><br><center><h4>TIDAK ADA FORMULIR PERMOHONAN PEMASANGAN JARINGAN BARU <br> PADA <?= $m3 .' '. $y3 ?></h4></center>
    <?php endif ; ?>
