...
<html><head>
    ...
    <hr>
    <?php if ($dl) : ?>
        <center><h5>LAPORAN FORMULIR PENDAFTARAN EMAIL LEMBAGA <?= $m3 .' '. $y3 ?></h5></center>
        <br><br>
    ...
    <?php else : ?>
        <br><br><br><br><br><br><center><h4>TIDAK ADA FORMULIR PENDAFTARAN EMAIL LEMBAGA <br> PADA <?= $m3 .' '. $y3 ?></h4></center>
    <?php endif ; ?>
