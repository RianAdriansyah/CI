        ...
        <div class="content mt-3">
        	...
        	<div class="col-lg-12 col-sm-12">
        		<div class="card bg-primary">
        			<div class="card-body">
        				<center>
        					<h2 class="text-light">WE ARE FROM ASSALAAM BANDUNG VOCATIONAL HIGHSCHOOL</h2>
        				</center>
        			</div>
        		</div>
        	</div>
        					...
        					<div class="card-body">
        						...
        						<table>
        							<tr>
        								...
        								<td>
        									<p class="card-text">0819-1018-6646
        								</td>
        							</tr>
        							<tr>
        								<td>
        								...
        								<td>
        									<p class="card-text">rianjh2@gmail.com
        								</td>
        							</tr>
        						</table>
        					</div>
        	...
        	<div class="col-lg-12 col-sm-12">
        		<div class="card bg-primary">
        			<div class="card-body">
        				<center>
        					<h2 class="text-light">WE ARE FROM VOCATIONAL HIGHSCHOOL 13 BANDUNG</h2>
        				</center>
        			</div>
        		</div>
        	</div>
        	...
        	<div class="col-sm-12 col-lg-6">
        		<div class="card mb-3" style="max-width: 540px;">
        			<div class="row no-gutters">
        				...
        				<div class="col-md-8">
        					<div class="card-body">
        						<h5 class="card-title">Gery Zidan Al-Gifari</h5>
        						<hr>
        						<table>
        							<tr>
        								<td>
        								...
        								<td>
        									<p class="card-text">0895-3340-29321
        								</td>
        							</tr>
        							<tr>
        								<td>
        								...
        								<td>
        									<p class="card-text">geryzidan4@gmail.com
        								</td>
        							</tr>
        						</table>
        					</div>
        	...
        	<div class="col-sm-12 col-lg-6">
        		<div class="card mb-3" style="max-width: 540px;">
        			<div class="row no-gutters">
        				...
        				<div class="col-md-8">
        					<div class="card-body">
        						<h5 class="card-title">Farhan Reza Yudistira</h5>
        						<hr>
        						<table>
        							<tr>
        								<td>
        							...
        							<tr>
        								...
        								<td>
        									<p class="card-text">mr.frhanrezaa@gmail.com
        								</td>
        							</tr>
        						</table>
        					</div>
        	...
        	<div class="col-sm-12 col-lg-6">
        		<div class="card mb-3" style="max-width: 540px;">
        			<div class="row no-gutters">
        				...
        				<div class="col-md-8">
        					<div class="card-body">
        						<h5 class="card-title">Muhamad Fikri D</h5>
        						<hr>
        						<table>
        							<tr>
        								<td>
        							...
        							<tr>
        								...
        								<td>
        									<p class="card-text">mfikrid22@gmail.com
        								</td>
        							</tr>
        						</table>
        					</div>
        	...
        	<div class="col-sm-12 col-lg-6">
        		<div class="card mb-3" style="max-width: 540px;">
        			<div class="row no-gutters">
        				...
        				<div class="col-md-8">
        					<div class="card-body">
        						<h5 class="card-title">Rifqi Agianto</h5>
        						<hr>
        						<table>
        							<tr>
        								<td>
        							...
        							<tr>
        								...
        								<td>
        									<p class="card-text">rifqiagi21@gmail.com
        								</td>
        							</tr>
        						</table>
        					</div>
