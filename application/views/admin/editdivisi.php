                ...
                <form style="padding: 5px;" action="" method="post">
                    <div class="form-row">
                        <div class="form-group col-md">
                            ...
                            <input value="<?= $edit['namadivisi'] ?>" type="text" class="form-control" id="divisi" name="divisi">
                    ...
                    <input type="hidden" name="dchain" value="<?= $edit['namadivisi'] ?>">
                    <div class="form-row">
                        <div class="form-group col-md">
                            <a type="button" class="btn btn-primary btn-block" href="<?= base_url('/'); ?>admin/tdivisi"><i class="fa fa-chevron-circle-left"></i> Kembali</a>
                        </div>
                        <div class="form-group col-md">
