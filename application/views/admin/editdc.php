    ...
    <div class="col-dm">
        <div class="page-header float-left">
            <div class="page-title">
                <h1>Edit Formulir Kunjungan Data Center</h1>
            </div>
        </div>
    </div>
</div>
			...
			<div class="card" style="margin-top: 40px; margin-bottom: 40px">
			  <div class="card-body">
			    <form style="padding: 5px; margin-top: 10px; margin-bottom: 20px;" action="" method="post">
				  ...
				  <div class="form-row">
				  	<div class="form-group col-md">
				  		<a type="button" class="btn btn-primary btn-block" href="<?= base_url('/'); ?>admin/dc"><i class="fa fa-chevron-circle-left"></i> Kembali</a>
				    </div>
				    <div class="form-group col-md">
