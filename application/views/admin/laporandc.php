...
<html><head>
    ...
    <hr>
    <?php if ($dc) : ?>
        <center><h5>LAPORAN FORMULIR KUNJUNGAN DATA CENTER <?= $m3 .' '. $y3 ?></h5></center>
        <br><br>
    ...
    <?php else : ?>
        <br><br><br><br><br><br><center><h4>TIDAK ADA FORMULIR KUNJUNGAN DATA CENTER <br> PADA <?= $m3 .' '. $y3 ?></h4></center>
    <?php endif; ?>
