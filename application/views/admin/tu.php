                ...
                <form style="padding: 5px;" action="" method="post">
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-2">
                            <button type="submit" id="kirim" name="kirim" class="btn btn-primary btn-block rounded" data-toggle="tooltip" data-placement="right" title="Tambah Unit"><i class="fas fa-plus-circle"></i></button>
                        </div>
                    </div>
                </form>
            </div>
