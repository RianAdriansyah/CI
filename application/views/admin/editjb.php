    ...
    <div class="col-dm">
        <div class="page-header float-left">
            <div class="page-title">
                <h1>Edit Formulir Permohonan Pemasangan Jaringan Baru</h1>
            </div>
        </div>
    </div>
</div>
			    ...
			    <form style="padding: 5px; margin-top: 10px; margin-bottom: 20px;" action="" method="post">
				  ...
				  <div class="form-row">
				    <div class="form-group col-md">
				      ...
				      <input value="<?= $edit['ni'] ?>" type="text" class="form-control" id="ni" name="ni">
				    </div>
				    <div class="form-group col-md">
				  ...
				  <div class="form-row">
				  	<div class="form-group col-md">
				  		<a type="button" class="btn btn-primary btn-block" href="<?= base_url('/'); ?>admin/jb"><i class="fa fa-chevron-circle-left"></i> Kembali</a>
				    </div>
				    <div class="form-group col-md">
